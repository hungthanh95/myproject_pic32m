...
typedef enum
{
    ...
    APP_USB_THREAD_STATE_WAIT_FOR_CONFIGURATION,

    /* Wait for a character receive */
    APP_USB_THREAD_STATE_SCHEDULE_READ,

    /* A character is received from host */
    APP_USB_THREAD_STATE_WAIT_FOR_READ_COMPLETE,

    /* Wait for the TX to get completed */
    APP_USB_THREAD_STATE_SCHEDULE_WRITE,

    /* Wait for the write to complete */
    APP_USB_THREAD_STATE_WAIT_FOR_WRITE_COMPLETE,
